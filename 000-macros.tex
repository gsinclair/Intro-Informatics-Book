...
% -------------- learninformatics, url, bitly urls

\newcommand{\learninformatics}{\textsf{learninformatics}}
\newcommand{\url}[1]{{\color{RoyalBlue}\texttt{#1}}}

\newcommand{\BitLyBook}{bit.ly/hsifcb-book}
\newcommand{\BitLyCode}{bit.ly/hsifcb-code}
...
% -------------- IN, OUT, learninformatics, url, colours, future reference, note
